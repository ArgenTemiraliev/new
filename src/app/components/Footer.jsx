        ...
        <footer className="bg-[#dbe7dd] text-black py-10">
            <div className="container mx-auto px-6 ">
                <div className="flex items-center gap-3 mb-6">
                    ...
                    <p className="text-l text-gray-500">  — самый удобный способ выбрать, как провести свободное время </p>
                </div>
                <div className="flex flex-col lg:flex-row justify-between gap-10">
                <div className="flex-1 flex flex-col justify-between">
                    <div className=" w-80 text-l space-y-2  text-gray-500">
                            <p className="py-6">Покупка билетов на мероприятия  для вашего удовольствия.</p>
                    ...
                    <div className="flex flex-col lg:flex-row justify-between items-center gap-6 lg:gap-12 p-4">
                            ...
                            <div className="text-center lg:text-left">
                                <div className="mb-4">
                                <h2 className="text-xl font-semibold mb-2">Развлечение в твоём телефоне</h2>
                                </div>
